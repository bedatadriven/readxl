...
#'   types.
#' @param .name_repair Treatment of problematic column names. If the tibble
#'   package version is recent enough, this offers full access to `.name_repair`
#'   as documented in [tibble::tibble()]. Otherwise, this falls back to name
#'   repair from tibble v1.4.2. Default behaviour ensures column names are not
#'   empty and are unique.
